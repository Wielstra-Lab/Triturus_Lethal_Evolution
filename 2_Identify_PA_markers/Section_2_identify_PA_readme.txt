...
### Run Select_presence_absence_1.R to create lists of Type 1 and 2 markers, as well identify which embryos are heterozygote or Type 1 or Type 2 homozygote 
...
Rscript Add_presence_absence_to_call_table_1.R Triturus_all_vcf_coverage_table.txt Triturus_PA/Triturus_PA_markers Triturus_PA_call

### Split into Type 1 and 2 markers again for seperate analysis